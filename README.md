 ...
 * IUDoubleLinkedList.java - main implementation of the doubly-linked list
 * Node.java - node class supporting both next and previous references
 * IndexedUnsortedList.java - interface defining list operations
 * ListTester.java - comprehensive testing framework with 7,000+ test cases
 * README - this file
